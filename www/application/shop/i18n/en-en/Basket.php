...
return [
	'model' => 'Покупательская корзина',
	'model prop Cnt' => 'Количество',
	'model prop ID' => 'Идентификатор',
	'model prop Name' => 'Название продукции',
	'model prop Price' => 'Цена продажи',
	'model prop Shop_Goods_ID' => 'Продукция',
